...
class MainActivity : AppCompatActivity(), OnClickListener, DialogoConfirmacion.Interfaz,
    ...
    override fun onClick(p0: View?) {
        when (p0!!.id) {
            ...
            binding.botonComunicar.id -> {
                ...
                DialogoComunicar.newInstance("Andrés", "Esto es un mensaje escrito desde el Main")
    ...
    override fun onDateSet(p0: DatePicker?, p1: Int, p2: Int, p3: Int) {
        binding.textFecha.text = "${p3}/${p2 + 1}/${p1}"
    }

    override fun onTimeSet(p0: TimePicker?, p1: Int, p2: Int) {
        binding.textHora.text = "${p1}:${p2}"
    }
